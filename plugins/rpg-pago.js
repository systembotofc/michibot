...
if ( users == 56941827124 || users == 56941827124 || users == 56941827124 || users == 56928561853 || users == 56928561853 || users == 56928561853 || users == 56928561853 || users == 56928561853) {
let grupos = [nna, nn, nnn, nnnt]
let gata = [img5, img6, img7, img8, img9]
let enlace = { contextInfo: { externalAdReply: {title: wm + ' 🐈', body: 'support group' , sourceUrl: grupos.getRandom(), thumbnail: await(await fetch(gata.getRandom())).buffer() }}}
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: 'MichiBot ', thumbnailUrl: await(await fetch(global.img)).buffer(), sourceUrl: yt }}}
